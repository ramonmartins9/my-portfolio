    	...
    	<PageContainer pageTitle={strings.link.hobbies} workTitle={strings.hobbies.cinema.title}>
			...
			<SimpleGrid columns={2} spacing={8}>
				<Box borderRadius="lg" overflow="hidden">
					<Image quality={100} layout="responsive" width="75%" height="100%" src="/parasita.png" />
				</Box>
				<Box borderRadius="lg" overflow="hidden">
					<Image quality={100} layout="responsive" width="75%" height="100%" src="/littlewoman.jpeg" />
				</Box>
				<Box borderRadius="lg" overflow="hidden">
					<Image quality={100} layout="responsive" width="70%" height="100%" src="/hamilton.jpg" />
				</Box>
				<Box borderRadius="lg" overflow="hidden">
					<Image quality={100} layout="responsive" width="70%" height="100%" src="/tarantino.jpeg" />
				</Box>
			</SimpleGrid>
			<Box borderRadius="lg" overflow="hidden">

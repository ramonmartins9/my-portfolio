    	...
    	<PageContainer pageTitle={strings.link.works} workTitle={strings.works.emprestei.title}>
			...
			<SimpleGrid columns={2} spacing={8}>
				<Box borderRadius="lg" overflow="hidden">
					<Image quality={100} layout="responsive" width="80%" height="100%" src="/e1.webp" />
				</Box>
				<Box borderRadius="lg" overflow="hidden">
					<Image quality={100} layout="responsive" width="80%" height="100%" src="/e2.webp" />
				</Box>
				<Box borderRadius="lg" overflow="hidden">
					<Image quality={100} layout="responsive" width="80%" height="100%" src="/e3.webp" />
				</Box>
				<Box borderRadius="lg" overflow="hidden">
					<Image quality={100} layout="responsive" width="80%" height="100%" src="/e4.webp" />
				</Box>
			</SimpleGrid>
	  	</PageContainer>
	</MainLayout>

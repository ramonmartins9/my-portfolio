...
const strings = new LocalizedStrings({
	ptBr:{
		home: {
			...
			works: "Works",
			worksBio: "I've been working professionally with development since the end of 2019, I love what I do, I've worked in various segments of the area, today I work in a software factory where I face daily challenges, maybe I imagine it's little experience, but before giving up on me, a look at some ",
			workTiny: "works ",
			period: "that I participated during that period.",
			bio: "Bio",
			born: "A little more precise, I was born in Salvador, Bahia. Yes, Salvador! You know, many beaches, but I don't go to any of them because I love movies, games and technology in general, nerd alert, but I sometimes go out... to watch movies at the theater. I used to be a good soccer player and won some championships, they called me show men (just me) and I made a song on my cell phone, the same one you can hear up there.",
			socialMedia: {
		...
		hobbies: {
			...
			cinema: {
				...
				stanza: ` The seventh art, I don't know where the passion for cinema came from, I remember starting to watch cinema according to Tiago Belloti and starting to see films in other ways, trying to unravel the filmmakers' minds and trying to understand what he wanted me to do. say in each scene.
			...
			soccer: {
				...
				The art of waiting, the fans of my time just hated me, because I didn't show the race to score, I didn't feel so well, I just knew how to wait, wait for the perfect opportunity to score, they impatiently didn't understand my strategy and always demanded throughout the match and I kept cool, waiting for the opportunity so as not to waste all the effort my team made for me to activate it, when the opportunity came I was prepared to score, I already knew everything I needed, how the defenders moved, the flaws in the defense line and the bad side of the goalkeeper, that made it easy, we just had to score and go out to celebrate, we didn't always win, but everyone did their part contributing together in a single goal, to win. We win and lose, but always together, that's what matters in this game!`,
			},
			bahia: {
				title: "Bahia",
